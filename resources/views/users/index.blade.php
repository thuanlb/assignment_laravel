                            ...
                            <table class="table table-head-fixed text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Posts</th>
                                        <th>Action</th>
                                        <th><a class="btn btn-success col-md-5" href="{{ route('users.create') }}">Thêm</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info " href="{{ route('users.show', $user->id) }}">Chi tiết</a></td>
                                            <td><a class="btn btn-secondary" href="{{ route('users.edit', $user->id) }}">Sửa</a>
